                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="blog-post">
                            ...
                            <a href="{{route('blog.single','le-prod')}}" class="h4 ">Marketing tips to grow your site template</a>
                            ...
                            <a href="{{route('blog.single','le-prod')}}" class="read-more">Read More <i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="blog-post">
                            ...
                            <a href="{{route('blog.single','le-prod')}}" class="h4 ">Build site tips to grow your site template</a>
                            <p class="mt-3">Distinctio nulla hic repudiandae aliquid sint architecto dolore similique
                                amet laboriosam suscipit in officia rerum, pariatuz.</p>
                            <a href="{{route('blog.single','le-prod')}}" class="read-more">Read More <i class="fa fa-angle-right"></i></a>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="blog-post">
                            ...
                            <a href="{{route('blog.single','le-prod')}}" class="h4 ">Falling in lin in google strategy</a>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="blog-post">
                            ...
                            <a href="{{route('blog.single','le-prod')}}" class="h4 ">Best tips to grow your site template</a>
                            <p class="mt-3">Distinctio nulla hic repudiandae aliquid sint architecto dolore similique
                                amet laboriosam suscipit in officia rerum, pariatuz.</p>
                            <a href="{{route('blog.single','le-prod')}}" class="read-more">Read More <i class="fa fa-angle-right"></i></a>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="blog-post">
                            <img src="{{asset('images/blog/blog-4.jpg')}}" alt="" class="img-fluid">
                            <div class="mt-4 mb-3 d-flex">
                                <div class="post-author mr-3">
                                    <i class="fa fa-user"></i>
                                    <span class="h6 text-uppercase">John mackel</span>
                            ...
                            <a href="{{route('blog.single','le-prod')}}" class="h4 ">Top growing channel tips lets follow</a>
                            <p class="mt-3">Distinctio nulla hic repudiandae aliquid sint architecto dolore similique
                                amet laboriosam suscipit in officia rerum, pariatuz.</p>
                            <a href="{{route('blog.single','le-prod')}}" class="read-more">Read More <i class="fa fa-angle-right"></i></a>
                        </div>
